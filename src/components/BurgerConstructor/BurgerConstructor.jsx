  ...
  return (
    <section className={`${styleBurgerConstruct.wrapper} mt-25 pl-4`}>
      <div className={`${styleBurgerConstruct.item__bun} pr-4`}>
        <ConstructorElement type={'top'} isLocked text={data[0].name + ' (верх)'} price={data[0].price} thumbnail={data[0].image} />
      </div>
      ...
      <div className={`${styleBurgerConstruct.item__bun} pr-4`}>
        <ConstructorElement type={'bottom'} isLocked text={data[0].name + ' (низ)'} price={data[0].price} thumbnail={data[0].image} />
      </div>
